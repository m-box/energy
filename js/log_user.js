	...
	var results=[];
                    ...
                    , success: function(res) {
						...
						if (result.data!=="error")
							...
							{$("#hello").html('Вітаю, '+ result.data.login +'( '+result.data.surename+' '+result.data.name+' '+result.data.fathername+' ) '+' <a href=# id=logout_ onclick="logout_1()" onclick="login_if()">Вийти</a> ');}
					}})
	/*var info = user_info();
